...
public class ProofDAO {
    public void insertProofs(String photoData, String signatureData, String proofDate, String idData, String letterData, int claimerId, String transactionId) throws SQLException {
        String sql = "INSERT INTO TS_PROOFS (PHOTO, SIGNATURE, PROOF_DATE, ID_PHOTO, LETTER_PHOTO, CLAIMER_ID, TRANSACTION_ID) VALUES (?, ?, ?, ?, ?, ?, ?)";
