...
public class ProofDAO {
    public void insertProofs(String photoData, String signatureData, String proofDate, String idData, String letterData, int claimerId, String orNumber, String fullName, String feeName) throws SQLException {
            String sql = "INSERT INTO TS_PROOFS (PHOTO, SIGNATURE, PROOF_DATE, ID_PHOTO, LETTER_PHOTO, CLAIMER_ID, OR_NUMBER, RELEASED_BY, FEE_NAME) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            try (Connection conn = DatabaseConnection.getConnection(); 
                ...
                stmt.setString(7, orNumber); 
                stmt.setString(8, fullName); 
                stmt.setString(9, feeName);
                stmt.executeUpdate();
            }
    }
}
