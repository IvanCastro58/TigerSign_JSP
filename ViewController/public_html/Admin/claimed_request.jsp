                ...
                <div class="table-wrapper">
                    ...
                    <thead>
                        ...
                        <tbody id="claimed-table-body">
                            ...
                            %>
                                <tr class="admin-clickable-row actual-data" style="display: none;">
       ...
       searchInput.addEventListener('input', function () {
        ...
        function renderPagination(filteredRows) {
            ...
            function createPaginationItem(content, isDisabled = false, isActive = false, page = null) {
                ...
                paginationLink.className = 'pagination-link' + (isActive ? ' active' : '') + (isDisabled ? ' disabled' : '');
                paginationLink.href = '#';
                ...
                if (!isDisabled && page !== null) {
                    ...
                    paginationLink.style.pointerEvents = 'none'; // Disable interaction for ellipses
                }
